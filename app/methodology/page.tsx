...
export default function MethodologyPage() {
  return (
    <div className="legacy-page min-h-screen px-5 py-10 max-w-2xl mx-auto relative z-10">
      ...
      <Link href="/" className="inline-flex items-center gap-2 text-sm mb-8 transition-colors" style={{ color: 'var(--muted)' }}>
      ...
      <p className="text-xs mb-8" style={{ color: 'var(--muted)' }}>Last updated: April 2026 · Version 2.0</p>
      ...
      <div className="flex flex-wrap gap-2 mb-10">
        {[
          ...
          <a key={item.id} href={`#${item.id}`} className="px-3 py-1.5 rounded-full text-xs font-medium glass-subtle transition-colors" style={{ color: 'var(--muted)' }}>
            {item.label}
          </a>
        ))}
      </div>
      ...
      <div className="space-y-10" style={{ color: 'rgba(240,240,244,0.7)', lineHeight: '1.8' }}>
        ...
        <section id="quality-score">
          <h2 className="text-xl font-bold heading-display mb-4" style={{ color: 'var(--dark)' }}>Quality Score</h2>
          ...
          <div className="rounded-xl p-5 font-mono text-sm space-y-2 mb-6" style={{ backgroundColor: 'rgba(19,19,26,0.8)', border: '1px solid rgba(34,199,126,0.15)', borderLeft: '3px solid #22c77e' }}>
            ...
            <p>&nbsp;</p>
            <p>A = Nutritional Quality <span style={{ color: 'var(--muted)' }}>(max 5.0 — 50%)</span></p>
            <p>B = Processing Level <span style={{ color: 'var(--muted)' }}>(max 2.5 — 25%)</span></p>
            <p>C = Additive Safety <span style={{ color: 'var(--muted)' }}>(max 2.0 — 20%)</span></p>
            <p>D = Organic Certification <span style={{ color: 'var(--muted)' }}>(max 0.5 — 5%)</span></p>
            <p>&nbsp;</p>
            <p>Total possible: <span style={{ color: '#22c77e' }}>10.0</span></p>
          </div>

          <h3 className="text-base font-semibold mb-2 mt-6" style={{ color: 'var(--dark)' }}>A — Nutritional Quality (50%)</h3>
          <p className="text-sm mb-3">Based on the <a href="https://www.santepubliquefrance.fr/determinants-de-sante/nutrition-et-activite-physique/articles/nutri-score" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--green)' }}>Nutri-Score algorithm</a>, a science-based nutrition scoring system used by 7+ European countries and endorsed by WHO&apos;s IARC. Measures energy, saturated fat, sugars, sodium (negative) against fibre, protein, and fruit/vegetable content (positive) per 100g.</p>
          <div className="rounded-xl p-4 text-sm mb-4" style={{ backgroundColor: 'rgba(19,19,26,0.6)', border: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <p className="text-xs" style={{ color: 'var(--muted)' }}>If nutritional data is unavailable, we contribute 2.5 points (neutral midpoint) and show a data warning.</p>
          </div>

          <h3 className="text-base font-semibold mb-2 mt-6" style={{ color: 'var(--dark)' }}>B — Processing Level (25%)</h3>
          <p className="text-sm mb-3">Based on the <a href="https://doi.org/10.1017/S1368980016000677" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--green)' }}>NOVA classification system</a> developed by Professor Carlos Monteiro at the University of São Paulo.</p>
          ...
          <div className="rounded-xl p-3 text-xs mb-4" style={{ backgroundColor: 'rgba(245,166,35,0.06)', border: '1px solid rgba(245,166,35,0.1)', color: 'var(--muted)' }}>
          ...
          <h3 className="text-base font-semibold mb-2 mt-6" style={{ color: 'var(--dark)' }}>C — Additive Safety (20%)</h3>
          <p className="text-sm mb-3">Starts at 2.0 (full marks). Deductions: -0.4 per high-concern additive, -0.15 per medium-concern, -0.3 additional for UK mandatory warning label additives. Based on <a href="https://www.food.gov.uk/business-guidance/approved-additives-and-e-numbers" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--green)' }}>UK FSA</a> and <a href="https://www.efsa.europa.eu/en/topics/topic/food-additives" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--green)' }}>EFSA</a> published positions. Every additive links to its official source.</p>

          <h3 className="text-base font-semibold mb-2 mt-6" style={{ color: 'var(--dark)' }}>D — Organic Certification (5%)</h3>
          ...
          {/* Score labels */}
          <h3 className="text-base font-semibold mb-2 mt-6" style={{ color: 'var(--dark)' }}>Score Labels</h3>
          <div className="space-y-1.5 mb-4">
            {[
              { range: '9.0 – 10.0', label: 'Excellent', color: 'var(--green)' },
              ...
              <div key={s.label} className="flex items-center justify-between py-1.5 px-3 rounded-lg" style={{ backgroundColor: `${s.color}08` }}>
                ...
                <span className="text-xs font-mono" style={{ color: 'var(--muted)' }}>{s.range}</span>
              </div>
            ))}
          </div>

          {/* Worked examples */}
          <h3 className="text-base font-semibold mb-3 mt-6" style={{ color: 'var(--dark)' }}>Worked Examples</h3>
          <div className="space-y-3">
            {[
              ...
              <div key={ex.name} className="rounded-xl p-4" style={{ backgroundColor: 'rgba(19,19,26,0.6)', border: '1px solid rgba(255,255,255,0.06)' }}>
                <p className="text-sm font-semibold mb-1" style={{ color: 'var(--dark)' }}>{ex.name}</p>
                <p className="text-xs mb-2" style={{ color: 'var(--muted)' }}>Nutri-Score {ex.ns} · NOVA {ex.nova} · Additives: {ex.add} · Organic: {ex.org}</p>
        ...
        <section id="processing-level">
          <h2 className="text-xl font-bold heading-display mb-4" style={{ color: 'var(--dark)' }}>Processing Level (NOVA)</h2>
          ...
          <p className="text-sm mb-3">NOVA scores from <a href="https://world.openfoodfacts.org" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--green)' }}>Open Food Facts</a> are used where available. Otherwise estimated from ingredient lists and labelled &quot;Estimated&quot;.</p>
        ...
        <section id="additives">
          <h2 className="text-xl font-bold heading-display mb-4" style={{ color: 'var(--dark)' }}>Additive Risk Ratings</h2>
          <p className="text-sm mb-3">Every additive is shown individually with a risk level and source link. Levels are based on published positions of the <a href="https://www.food.gov.uk/business-guidance/approved-additives-and-e-numbers" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--green)' }}>UK FSA</a> and <a href="https://www.efsa.europa.eu" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--green)' }}>EFSA</a>.</p>
        ...
        <section id="data-sources">
          <h2 className="text-xl font-bold heading-display mb-4" style={{ color: 'var(--dark)' }}>Data Sources</h2>
          <div className="space-y-3">
            {[
              ...
              <a key={s.name} href={s.url} target="_blank" rel="noopener noreferrer" className="block rounded-xl p-4 transition-all" style={{ backgroundColor: 'rgba(19,19,26,0.6)', border: '1px solid rgba(255,255,255,0.06)' }}>
                <p className="text-sm font-semibold" style={{ color: 'var(--dark)' }}>{s.name}</p>
                <p className="text-xs" style={{ color: 'var(--muted)' }}>{s.desc} {s.licence && `· ${s.licence}`}</p>
              </a>
            ))}
          </div>
        </section>
        ...
        <section id="limitations">
          <h2 className="text-xl font-bold heading-display mb-4" style={{ color: 'var(--dark)' }}>What We Don&apos;t Do</h2>
          <div className="space-y-3">
            {[
              ...
              <div key={l.title} className="rounded-xl p-4" style={{ backgroundColor: 'rgba(245,166,35,0.04)', borderLeft: '3px solid rgba(245,166,35,0.3)' }}>
                <p className="text-sm font-semibold mb-1" style={{ color: 'var(--dark)' }}>{l.title}</p>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="rounded-xl p-4" style={{ backgroundColor: 'rgba(19,19,26,0.6)', border: '1px solid rgba(255,255,255,0.06)' }}>
              ...
              <p className="text-xs mt-1" style={{ color: 'var(--muted)' }}>Four-component scoring: Nutritional quality (50% via Nutri-Score), Processing level (25% via NOVA), Additives (20%), Organic (5%). Beverage-specific sugar thresholds. Score breakdown UI.</p>
            </div>
            <div className="rounded-xl p-4" style={{ backgroundColor: 'rgba(19,19,26,0.6)', border: '1px solid rgba(255,255,255,0.06)' }}>
              <p className="text-sm font-semibold" style={{ color: 'var(--muted)' }}>Version 1.0 — March 2026</p>
              <p className="text-xs mt-1" style={{ color: 'var(--muted)' }}>Initial launch. Score based primarily on additive presence with Nutri-Score and NOVA as modifiers.</p>
            </div>
          </div>
        </section>
        ...
        <section id="data-verification">
          <h2 className="text-xl font-bold heading-display mb-4" style={{ color: 'var(--dark)' }}>How Product Data is Verified</h2>
          ...
          <div className="space-y-4">
            <div className="rounded-xl p-4" style={{ backgroundColor: 'rgba(19,19,26,0.6)', border: '1px solid rgba(255,255,255,0.06)' }}>
              <p className="text-sm font-semibold mb-1" style={{ color: 'var(--dark)' }}>Automated data quality checks</p>
              <p className="text-xs" style={{ color: 'var(--muted)' }}>Our system automatically flags incomplete or inconsistent entries — such as missing ingredient lists, implausible nutrient values, or unrecognised ingredient formats. Products with insufficient data are shown with a warning rather than a score.</p>
            </div>
            <div className="rounded-xl p-4" style={{ backgroundColor: 'rgba(19,19,26,0.6)', border: '1px solid rgba(255,255,255,0.06)' }}>
              <p className="text-sm font-semibold mb-1" style={{ color: 'var(--dark)' }}>Ingredient parsing</p>
              <p className="text-xs" style={{ color: 'var(--muted)' }}>Our ingredient parser identifies likely errors — including formatting inconsistencies, encoding issues, truncated text, and entries that do not match known ingredient patterns. Flagged products are marked as &quot;data may be incomplete&quot; until resolved.</p>
            </div>
            <div className="rounded-xl p-4" style={{ backgroundColor: 'rgba(19,19,26,0.6)', border: '1px solid rgba(255,255,255,0.06)' }}>
              <p className="text-sm font-semibold mb-1" style={{ color: 'var(--dark)' }}>Community corrections</p>
              <p className="text-xs" style={{ color: 'var(--muted)' }}>Since Open Food Facts and Open Beauty Facts are community-maintained, errors can be corrected directly at source by any contributor. IngredScan reflects the latest available data from these databases.</p>
            </div>
            <div className="rounded-xl p-4" style={{ backgroundColor: 'rgba(19,19,26,0.6)', border: '1px solid rgba(255,255,255,0.06)' }}>
              <p className="text-sm font-semibold mb-1" style={{ color: 'var(--dark)' }}>User reporting</p>
              <p className="text-xs" style={{ color: 'var(--muted)' }}>Users can report incorrect product data directly in the app. Reported issues are reviewed and, where possible, corrections are submitted back to the Open Food Facts / Open Beauty Facts community.</p>
            </div>
          </div>
        ...
        <div className="rounded-xl p-5 text-center" style={{ backgroundColor: 'rgba(34,199,126,0.04)', border: '1px solid rgba(34,199,126,0.1)' }}>
          <p className="text-sm mb-2" style={{ color: 'var(--dark)' }}>Have a question about our methodology?</p>
          <a href="mailto:support@ingredscan.com" className="text-sm font-medium" style={{ color: 'var(--green)' }}>support@ingredscan.com →</a>
        </div>
      </div>
    </div>
  )
