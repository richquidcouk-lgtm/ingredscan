              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-3">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px]" style={{ color: 'rgba(240,240,244,0.35)' }}>Instant access</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#22c77e" strokeWidth="2.5"><polyline points="20,6 9,17 4,12" /></svg>
                    <span className="text-[10px]" style={{ color: 'rgba(240,240,244,0.35)' }}>Works offline</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#22c77e" strokeWidth="2.5"><polyline points="20,6 9,17 4,12" /></svg>
                    <span className="text-[10px]" style={{ color: 'rgba(240,240,244,0.35)' }}>Always up to date</span>
                  </div>
                </div>
              </div>
            </div>
