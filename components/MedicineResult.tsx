...
export default function MedicineResult({ product, onBack }: Props) {
  return (
      ...
      <div className="px-5 max-w-lg mx-auto space-y-4 relative z-10">
        ...
        <div className="rounded-2xl p-5 animate-fadeUp" style={{ backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', animationDelay: '50ms' }}>
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-bold mb-2" style={{ color: '#f0f0f4' }}>Medicine or Medical Product</h3>
              <p className="text-xs leading-relaxed" style={{ color: 'rgba(240,240,244,0.55)' }}>
                IngredScan is a food and cosmetics scanner. We don&apos;t identify, score, or provide information on medicines, prescription products, or medical foods.
              </p>
            </div>
          </div>
        </div>

        {/* Why we don't cover medicines */}
        <div className="rounded-2xl p-5 glass-card animate-fadeUp" style={{ animationDelay: '100ms' }}>
          <h3 className="text-sm font-semibold mb-3" style={{ color: '#f0f0f4' }}>Why We Don&apos;t Cover Medicines</h3>
          <p className="text-xs leading-relaxed mb-3" style={{ color: 'rgba(240,240,244,0.55)' }}>
            Medicines and pharmaceutical products require specialist medical and pharmacological knowledge to assess safely. Providing ingredient analysis or scores for medicines could be misleading or harmful.
          </p>
          <p className="text-xs leading-relaxed" style={{ color: 'rgba(240,240,244,0.55)' }}>
            For information about medicines: always read the patient information leaflet included with the product, speak with your pharmacist, or consult your GP.
          </p>
        </div>

        {/* Helpful links */}
        <div className="space-y-2 animate-fadeUp" style={{ animationDelay: '150ms' }}>
          <a href="https://www.nhs.uk/medicines/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 rounded-2xl p-4 glass-card transition-all active:scale-[0.98]">
            <span className="text-xl">💊</span>
            <div className="flex-1">
              <p className="text-sm font-medium" style={{ color: '#f0f0f4' }}>NHS Medicines A-Z</p>
          ...
          <a href="https://www.medicines.org.uk/emc" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 rounded-2xl p-4 glass-card transition-all active:scale-[0.98]">
            <span className="text-xl">🔍</span>
            <div className="flex-1">
              <p className="text-sm font-medium" style={{ color: '#f0f0f4' }}>Check Medicine Ingredients (EMC)</p>
              <p className="text-xs" style={{ color: 'rgba(240,240,244,0.35)' }}>medicines.org.uk</p>
            </div>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(240,240,244,0.3)" strokeWidth="2"><path d="M7 17L17 7M17 7H7M17 7V17" /></svg>
          </a>
          <a href="https://111.nhs.uk" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 rounded-2xl p-4 glass-card transition-all active:scale-[0.98]">
            <span className="text-xl">📞</span>
            <div className="flex-1">
              <p className="text-sm font-medium" style={{ color: '#f0f0f4' }}>NHS 111</p>
              <p className="text-xs" style={{ color: 'rgba(240,240,244,0.35)' }}>111.nhs.uk</p>
            </div>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(240,240,244,0.3)" strokeWidth="2"><path d="M7 17L17 7M17 7H7M17 7V17" /></svg>
          </a>
        </div>
